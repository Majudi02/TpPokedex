    ...
    <div class="container mt-5 pb-5">
        ...
        if (is_array($resultadoBusqueda) && isset($resultadoBusqueda[0])) {
            ...
            foreach ($resultadoBusqueda as $pokemon) {
                ...
                echo "<td><a href='vistaPokemon.php?id_unico=" . urlencode($pokemon['id_unico']) . "'><img src='./Imagenes/" . htmlspecialchars($pokemon['imagen']) . "' alt='" . htmlspecialchars($pokemon['nombre']) . "' width='50'></a></td>";
        ...
        elseif (is_array($resultadoBusqueda) && isset($resultadoBusqueda['id'])) {
            ...
            echo "<td><a href='vistaPokemon.php?id_unico=" . urlencode($resultadoBusqueda['id_unico']) . "'><img src='./Imagenes/" . htmlspecialchars($resultadoBusqueda['imagen']) . "' alt='" . htmlspecialchars($resultadoBusqueda['nombre']) . "' width='50'></a></td>";
        ...
        if (!isset($_POST["pokemonBuscado"]) || $resultadoBusqueda === false) {
            ...
            foreach ($pokemones as $pokemon) {
                ...
                echo "<td>" . htmlspecialchars($pokemon['id']) . "</td>";
                echo "<td><a href='vistaPokemon.php?id_unico=" . urlencode($pokemon['id_unico']) . "'>" . htmlspecialchars($pokemon['nombre']) . "</a></td>";
                echo "<td><a href='vistaPokemon.php?id_unico=" . urlencode($pokemon['id_unico']) . "'><img src='images/" . htmlspecialchars($pokemon['imagen']) . "' alt='" . htmlspecialchars($pokemon['nombre']) . "' width='50'></a></td>";
                $tipo = getTipoById($pokemon['tipo_id'], $db);
